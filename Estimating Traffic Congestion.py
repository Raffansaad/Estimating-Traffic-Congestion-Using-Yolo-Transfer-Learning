...
Original file is located at
    https://colab.research.google.com/drive/1gWxyc-qft_UhMN_pmoQS-3k9YctH_Zzt
...
"""Then, import all the essential libraries needed for the project:"""
...
dataset_path = '/content/drive/MyDrive/Major-Project(Research-papers)/Vehicle_Detection_Image_Dataset'
...
# Train the model on the CPU instead of GPU
results = model.train(
...
post_training_files_path = '/content/runs'
...
confusion_matrix_path = os.path.join(post_training_files_path, '/content/runs/detect/train/confusion_matrix_normalized.png')
...
best_model_path = os.path.join(post_training_files_path, '/content/runs/detect/train/weights/best.pt')
...
# Path to the image file
sample_image_path = '/content/drive/MyDrive/Major-Project(Research-papers)/Vehicle_Detection_Image_Dataset/sample_image.jpg'
...
dataset_video_path = '/content/drive/MyDrive/Major-Project(Research-papers)/Vehicle_Detection_Image_Dataset/sample_video.mp4'
